...
const About = () => {
    return (
        <div className='px-6 pt-6 overflow-hidden text-start pb-12 bg-[var(--color-bg)]'>
            ...
            <div className='relative mb-16 flex items-center justify-center'>
                <div className='bg-amber-500 rounded-xl w-full max-w-70 sm:max-w-full h-65 mt-9 '></div>
                <img className='w-full min-w-130 absolute top-0' src={lamboRed} alt="Lamborghini vermelha" />
            </div>
            ...
            <div className='border-t flex flex-col gap-14 pt-20 mt-18 border-zinc-200 w-full'>
                ...
                <div className='relative flex items-center justify-center'>
                    ...
                    <img className='w-full min-w-130 absolute top-25 right-15' src={larenWhite} alt="Lamborghini vermelha" />
                </div>
                <div>
