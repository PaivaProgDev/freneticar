...
const Home = () => {
  return (
    <section className="overflow-hidden m-auto w-full max-w-6xl">
      <div className="px-6 pt-6 md:px-20 overflow-hidden relative pb-12 bg-[var(--color-bg)]">
        ...
        <img
          className="w-full md:absolute md:-translate-y-80 min-w-[24rem] translate-x-6 md:translate-x-140 md:max-w-fit mt-14 mb-8"
          src={homeImage}
          alt="Imagem de um BMW M2"
        />
        <div className="w-full max-w-2xl md:mt-40">
        ...
        <div className="flex justify-between md:justify-center gap-20 mt-14">
          <div className="flex flex-col items-center">
            <div className="bg-[var(--color-3)] w-fit p-3 rounded-xl">
              <Zap className="text-[var(--color-4)]" />
            </div>
            <strong>500+</strong>
            <span>HP Médio</span>
          </div>
          <div className="flex flex-col items-center">
            <div className="bg-[var(--color-3)] w-fit p-3 rounded-xl">
              <Gem className="text-[var(--color-4)]" />
            </div>
            <strong>50+</strong>
            <span>Modelos</span>
          </div>
          <div className="flex flex-col items-center">
            <div className="bg-[var(--color-3)] w-fit p-3 rounded-xl">
              <Users className="text-[var(--color-4)]" />
            </div>
            <strong>1000+</strong>
            <span>Clientes</span>
          </div>
        ...
        <div className="flex flex-col items-center">
          <div className="flex gap-4 justify-between items-center mt-24">
            <h3 className="text-5xl text-center w-full font-black text-[var(--color-4)]">
              Mais Vendidos
            </h3>
            <FlameIcon className="size-10 stroke-red-400" />
          </div>
          <p className="mt-6 md:text-center flex w-full md:w-100 text-[var(--color-4)]">
        ...
        <Link to={"/gallery"}>
          <Button className={"mt-16 md:max-w-[22rem]"}>
